...
description: >
  ...
  Enforces root cause investigation before any fix attempts.
---
...
4. **Gather Evidence in Multi-Component Systems**
   - For each component boundary: log what data enters, what exits
...
4. **If Fix Doesn't Work** - If >= 3 failed fixes: STOP and question the architecture
