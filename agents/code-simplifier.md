...
description: >
  ...
  Use after completing a feature or when code needs cleanup.
model: {{MODEL}}
tools:
  - read_file
  - replace
...
2. **Apply Project Standards**: Follow the established coding standards from project configuration files (GEMINI.md, CLAUDE.md, etc.).
